...
func TestAccComputeFirewallPolicyRule_basic(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
      ...
      {
				Config: testAccComputeFirewallPolicyRule_basicUpdate(context),
			},
			{
				ResourceName:      "google_compute_firewall_policy_rule.fw_policy_rule",
				ImportState:       true,
...
resource "google_compute_network" "network" {
  name                    = "tf-test-netwrork-%{random_suffix}"
...
resource "google_compute_firewall_policy_rule" "fw_policy_rule" {
  ...
  match {
    ...
    src_secure_tags {
      name = "tagValues/${google_tags_tag_value.value.name}"
    }
...
resource "google_tags_tag_key" "key" {
  ...
  purpose_data = {
    network = "%{project_name}/${google_compute_network.network.name}"
  }
}
...
func testAccComputeFirewallPolicyRule_basicUpdate(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_compute_network" "network" {
  name                    = "tf-test-netwrork-%{random_suffix}"
  auto_create_subnetworks = false
