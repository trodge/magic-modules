...
1. [Run provider tests locally](/magic-modules/how-to/run-tests/#run-provider-tests-locally) that are relevant to the change you made. (Testing the PR locally and pushing the commit to the PR only after the tests pass locally may significantly reduce back-and-forth in review.)
